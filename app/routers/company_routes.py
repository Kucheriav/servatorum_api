...
from app.scripts_utlis.dependencies import owner_or_admin, get_current_user
...
async def patch_company(company_id: int, company_params_to_patch: CompanyPatch, current_actor=Depends(owner_or_admin)):
...
async def delete_company(company_id: int, current_actor=Depends(owner_or_admin)):
