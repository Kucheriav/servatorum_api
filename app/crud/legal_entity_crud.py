# deprecated: refactored this into Company and Foundation
...
#         try:
#             new_legal_entity = LegalEntityBase(
...
#         try:
#             query = select(LegalEntityBase).where(LegalEntityBase.id == legal_entity_id)
...
#                 raise CompanyNotFoundError(f"LEGAL_ENTITY_NOT_FOUND: {legal_entity_id}")
#         except Exception as e:
